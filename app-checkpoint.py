...
- **Forecast freght costs accurately**
- **Detect risky or abnormal vendor invoices **
- **Reduce financial leakage and manaul workload**
""")
...
if selected_model =="Freight Cost Prediction":
    ...
    **Objectives:**
    ...
    to supoort budgeting,forecasting,and vendor negotiations.
    """)
...
#=========================================
    ...
    **Objective:**
    ...
    based on abnoarmal cost,freight,or delivery patterns.
    """)
    ...
    with st.form("invoice_flag_form"):
        ...
        submit_flag = st.form_sub,it_button(" Evaluate Invoice Risk")
